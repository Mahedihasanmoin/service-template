...
<html lang="en">
  ...
  <div class="container mt-6">
    ...
    <div class="row mt-4">
      <div class="col-md-12 col-sm-12">
        <p class="text-center" style="padding: .75rem 1rem;margin-bottom: 1rem;background-color: #e9ecef;border-radius: .25rem;">Online photo Editor</p>
      </div>  
      <div class="col-md-6 col-sm-6">
        <div class="card">
    ...
    <div class="row mt-4">
      <div class="col-md-12 col-sm-12">
        <p class="text-center" style="padding: .75rem 1rem;margin-bottom: 1rem;background-color: #e9ecef;border-radius: .25rem;">Json Beautifier</p>
      </div>
      <div class="col-md-6 col-sm-6">
        <div class="card">
          <img class="card-img" alt="json.png" src="images/json.png" data-holder-rendered="true" style="height: 100%; width: 100%; display: block;">
        </div>
      </div>
      <div class="col-md-6 col-sm-6">
        <div class="row">
          <div class="col-md-6 col-sm-6">
            <a href="http://internet-speed-test.info" target="_blank"><h5>Json Viewer</h5></a>
            <p>Sed tellus fusce velit orci aliquet et condimentum sit amet dapibus eget odio vivamus urna pellentesque felis…</p>
          </div>
          <div class="col-md-6 col-sm-6">
            <a href="http://internet-speed-test.info" target="_blank"><h5>Json Beautifier</h5></a>
            <p>Ut quam imperdiet tincidunt vestibulum eget magna eget sem imperdiet tincidunt praesent sit amet adipiscing…</p>
          </div>
          <div class="col-md-6 col-sm-6">
            <a href="http://internet-speed-test.info" target="_blank"><h5>Json Validator</h5></a>
            <p>Accumsan curabitur cursus porta lectus nam posuere orci in elementum molestie purus erat volutpat ullamcorper…</p>
          </div>
          <div class="col-md-6 col-sm-6">
            <a href="http://internet-speed-test.info" target="_blank"><h5>Json Reader</h5></a>
            <p>Elit purus non odio etiam dictum euismod lectus vestibulum tincidunt erat vel molestie gravida ligula lacus…</p>
          </div>
        </div>
      </div>
  ...
  <!-- </div> -->
    ...
    <script src="js/bootstrap_4.1.1.bundle.min.js"></script>
